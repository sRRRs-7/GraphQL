import { Link, EntityField, FieldInfo, StorageAdapter, SerializedEntries, Dependencies, OperationType, Data } from '../types';
...
export declare const makeData: (data?: Data | undefined) => Data;
export declare const isWriting: () => boolean;
export declare const ownsData: (data?: Data | undefined) => boolean;
/** Before reading or writing the global state needs to be initialised */
export declare const initDataState: (operationType: OperationType, data: InMemoryData, layerKey?: number | null | undefined, isOptimistic?: boolean | undefined) => void;
...
export declare const reserveLayer: (data: InMemoryData, layerKey: number, hasNext?: boolean | undefined) => void;
