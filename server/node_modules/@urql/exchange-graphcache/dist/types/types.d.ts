...
export declare type Resolver<ParentData = DataFields, Args = Variables, Result = ResolverResult> = {
...
export declare type UpdateResolver<ParentData = DataFields, Args = Variables> = {
...
export declare type OptimisticMutationResolver<Args = Variables, Result = Link<Data> | Scalar> = {
    bivarianceHack(vars: Args, cache: Cache, info: ResolveInfo): Result;
}['bivarianceHack'];
export declare type OptimisticMutationConfig = {
    [mutationFieldName: string]: OptimisticMutationResolver;
};
export declare type KeyingConfig = {
