...
function readSelection(e, t, r, i, n) {
  ...
  while (void 0 !== (p = c())) {
    ...
    if ("__typename" === m) {
      ...
      updateContext(e, v, u, s, N, m);
      if (void 0 !== O) {
        v[g] = O;
      }
      b = E[m](v, h || {}, a, e);
      if (p.selectionSet) {
        b = resolveResolverResult(e, u, m, N, getSelectionSet(p), void 0 !== v[g] ? v[g] : i[g], b, ownsData(i));
      }
      ...
      b = resolveResolverResult(e, u, m, N, getSelectionSet(p), void 0 !== v[g] ? v[g] : i[g], _, ownsData(i));
    } else {
      var D = readLink(s, k);
      if (void 0 !== D) {
...
function cacheExchange(r) {
  return function(i) {
    ...
    function updateCacheWithResult(e, t) {
      ...
      reserveLayer(s.data, r.key, "subscription" === r.kind || e.hasNext);
      var o;
      var u = e.data;
      if (u) {
...
exports.offlineExchange = function offlineExchange(r) {
  return function(n) {
    ...
    if (a && a.onOnline && a.readMetadata && a.writeMetadata) {
        ...
        forward: function(e) {
          return t.filter((function(e) {
            if ("mutation" === e.operation.kind && isOfflineError(e.error) && function isOptimisticMutation(e, t) {
              ...
              p.push(m.get(e.operation.context._instance) || e.operation);
              updateMetadata();
              return !1;
            }
            if ("mutation" === e.operation.kind && !e.error) {
              m.delete(e.operation.context._instance);
            }
            return !0;
          }))(o(e));
        }
      ...
      var m = new WeakMap;
      return function(e) {
        var r = t.share(t.tap((function(e) {
          if ("mutation" === e.kind) {
            m.set(e.context._instance, e);
          }
        }))(e));
        var i = t.merge([ l, r ]);
        return t.filter((function(e) {
