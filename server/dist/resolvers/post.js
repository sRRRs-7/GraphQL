...
let PostResolver = class PostResolver {
    ...
    posts(limit, cursor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const posts = yield Post_1.Post.query(`
    ...
    createPost(input, { req }) {
        return __awaiter(this, void 0, void 0, function* () {
            return Post_1.Post.create(Object.assign(Object.assign({}, input), { points: 0, creatorId: req.session.userId })).save();
        });
    }
    updatePost(id, title, text, { req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof title !== "undefined") {
                ...
                yield Post_1.Post.update({ id: id, creatorId: req.session.userId }, { title, text });
            }
            return post;
        });
    }
